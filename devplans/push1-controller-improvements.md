...
### 3.7 Sequencer modes & Note/Play selector

- **Design pointer**
  - Behaviour/UX/data model for the ratchet/polymeter note sequencer live in `devplans/push1-sequencer-mode.md`.
  - Behaviour/UX/data model for the parameter sequencer live in `devplans/push-parameter-sequencer-mode.md`.
  - **Implementation and rollout status** for these modes (including their SHIFT-banked Note/Play selector integration) is tracked centrally in `devplans/status.md` under *Sequencer Modes & Note/Play Selector*.
