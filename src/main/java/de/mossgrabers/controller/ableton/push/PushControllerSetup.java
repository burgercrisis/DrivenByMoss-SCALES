...
import de.mossgrabers.controller.ableton.push.command.trigger.CustomScaleCreationCommand;
...
import de.mossgrabers.controller.ableton.push.mode.CustomScaleCreationMode;
...
public class PushControllerSetup extends AbstractControllerSetup<PushControlSurface, PushConfiguration> {
        ...
        private static final String[] MIDI_FILTER_MPE = {
                        ...
                        "DE????",
                        "DF????",
                        // Pitch-bend (MPE) - channel 1-15 -> now handled in handleMidi to support
                        // scales
                        // "E1????",
                        // "E2????",
                        // "E3????",
         ...
         */
        public PushControllerSetup(final IHost host, final ISetupFactory factory, final ISettingsUI globalSettings,
                        final ISettingsUI documentSettings, final PushVersion pushVersion) {
        ...
        protected void createModel() {
                ...
                this.model = this.factory.createModel(this.configuration, this.colorManager, this.valueChanger,
                                this.scales,
                                ms);
        ...
        protected void createSurface() {
                ...
                final IMidiInput input = midiAccess.createInput("Pads",
                                this.pushVersion == PushVersion.VERSION_3 ? MIDI_FILTER_MPE : MIDI_FILTERS_CLASSIC);
                final PushControlSurface surface = new PushControlSurface(this.host, this.colorManager,
                                this.configuration,
                                output, input);
                this.surfaces.add(surface);

                if (this.pushVersion == PushVersion.VERSION_1)
                        surface.addTextDisplay(
                                        new Push1Display(this.host, this.valueChanger.getUpperBound(), output,
                                                        this.configuration));
                else
                        surface.addGraphicsDisplay(
                                        new Push2Display(this.host, this.valueChanger.getUpperBound(),
                                                        this.configuration));
        ...
        protected void createModes() {
                ...
                for (int i = 0; i < 8; i++)
                        modeManager.register(Modes.get(Modes.DEVICE_LAYER_SEND1, i),
                                        new DeviceLayerSendMode(surface, this.model, i));
                ...
                modeManager.register(Modes.SCALE_CREATION, new CustomScaleCreationMode(surface, this.model));
        ...
        protected void createObservers() {
                ...
                switch (this.configuration.getPushVersion()) {
                        case PushVersion.VERSION_1:
                                this.configuration.addSettingObserver(PushConfiguration.VELOCITY_CURVE,
                                                surface::sendPadSensitivityPush1);
                                this.configuration.addSettingObserver(PushConfiguration.PAD_PUSH1_THRESHOLD,
                                                surface::sendPadSensitivityPush1);
                                break;

                        case PushVersion.VERSION_2:
                                this.configuration.addSettingObserver(PushConfiguration.DISPLAY_BRIGHTNESS,
                                                surface::sendDisplayBrightness);
                                this.configuration.addSettingObserver(PushConfiguration.LED_BRIGHTNESS,
                                                surface::sendLEDBrightness);
                                this.configuration.addSettingObserver(PushConfiguration.PAD_PUSH2_SENSITIVITY,
                                                surface::sendPadSensitivityPush2);
                                this.configuration.addSettingObserver(PushConfiguration.PAD_PUSH2_GAIN,
                                                surface::sendPadSensitivityPush2);
                                this.configuration.addSettingObserver(PushConfiguration.PAD_PUSH2_DYNAMICS,
                                                surface::sendPadSensitivityPush2);
                                break;
                        ...
                        case PushVersion.VERSION_3:
                                ...
                                this.configuration.addSettingObserver(PushConfiguration.LED_BRIGHTNESS,
                                                surface::sendLEDBrightness);
                                this.configuration.addSettingObserver(PushConfiguration.PAD_PUSH3_THRESHOLD,
                                                surface::sendPadSensitivityPush3);
                                this.configuration.addSettingObserver(PushConfiguration.PAD_PUSH3_DRIVE,
                                                surface::sendPadSensitivityPush3);
                                this.configuration.addSettingObserver(PushConfiguration.PAD_PUSH3_COMPAND,
                                                surface::sendPadSensitivityPush3);
                                this.configuration.addSettingObserver(PushConfiguration.PAD_PUSH3_RANGE,
                                                surface::sendPadSensitivityPush3);
                                break;
                }

                this.configuration.addSettingObserver(PushConfiguration.RIBBON_MODE, this::updateRibbonMode);
                this.configuration.addSettingObserver(PushConfiguration.RIBBON_MODE_NOTE_REPEAT,
                ...
                if (this.pushVersion == PushVersion.VERSION_3) {
                        ...
                        this.configuration.addSettingObserver(PushConfiguration.PREAMP_TYPE_1,
                                        surface::sendPreamp1Type);
                        this.configuration.addSettingObserver(PushConfiguration.PREAMP_TYPE_2,
                                        surface::sendPreamp2Type);
                        this.configuration.addSettingObserver(PushConfiguration.PREAMP_GAIN_1,
                                        surface::sendPreamp1Gain);
                        this.configuration.addSettingObserver(PushConfiguration.PREAMP_GAIN_2,
                                        surface::sendPreamp2Gain);
                        this.configuration.addSettingObserver(PushConfiguration.AUDIO_OUTPUTS,
                                        surface::sendOutputConfiguration);
                }
        ...
        protected void registerTriggerCommands() {
                ...
                this.addButton(ButtonID.PLAY, "Play", new PlayCommand<>(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_PLAY, t::isPlaying,
                                PushColorManager.PUSH_BUTTON_STATE_PLAY_ON,
                                PushColorManager.PUSH_BUTTON_STATE_PLAY_HI);

                this.addButton(ButtonID.RECORD, "Record", new RecordCommand<>(this.model, surface),
                                ...
                                }, PushColorManager.PUSH_BUTTON_STATE_REC_ON, PushColorManager.PUSH_BUTTON_STATE_REC_HI,
                                PushColorManager.PUSH_BUTTON_STATE_OVR_ON, PushColorManager.PUSH_BUTTON_STATE_OVR_HI);

                this.addButton(ButtonID.NEW, "New", new NewCommand<>(this.model, surface),
                                isPush3 ? PushControlSurface.PUSH_3_BUTTON_NEW : PushControlSurface.PUSH_BUTTON_NEW);
                this.addButton(ButtonID.FIXED_LENGTH, "Fixed Length", new FixedLengthCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_FIXED_LENGTH, () -> modeManager.isActive(Modes.FIXED));
                this.addButton(ButtonID.DUPLICATE, "Duplicate", new DuplicateCommand<>(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_DUPLICATE);
                this.addButton(ButtonID.QUANTIZE, "Quantize", new PushQuantizeCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_QUANTIZE);
                this.addButton(ButtonID.DELETE, "Delete", new DeleteCommand<>(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_DELETE);
                this.addButton(ButtonID.DOUBLE, "Double Loop", new DoubleCommand<>(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_DOUBLE);
                this.addButton(ButtonID.UNDO, "Undo", new UndoCommand<>(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_UNDO, () -> {
                ...
                this.addButton(ButtonID.AUTOMATION, "Automate", new PushAutomationCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_AUTOMATION, () -> {
                ...
                this.addButton(ButtonID.TRACK, this.pushVersion == PushVersion.VERSION_1 ? "Track" : "Mix",
                                new TrackCommand(this.model, surface), PushControlSurface.PUSH_BUTTON_TRACK,
                                () -> this.pushVersion == PushVersion.VERSION_1 ? modeManager.isActive(Modes.TRACK)
                                                : Modes.isMixMode(modeManager.getActiveID()));
                this.addButton(ButtonID.DEVICE, "Device", new DeviceCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_DEVICE,
                                () -> Modes.isDeviceMode(modeManager.getActiveID()));

                this.addButton(ButtonID.CLIP, "Clip", new ClipCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_CLIP,
                                () -> modeManager.isActive(Modes.CLIP));

                for (int i = 0; i < 8; i++) {
                        final ButtonID row1ButtonID = ButtonID.get(ButtonID.ROW1_1, i);
                        this.addButton(row1ButtonID, "Row 1: " + (i + 1),
                                        new ButtonRowModeCommand<>(0, i, this.model, surface),
                                        PushControlSurface.PUSH_BUTTON_ROW1_1 + i,
                                        () -> this.getModeColor(row1ButtonID));
                        final ButtonID row2ButtonID = ButtonID.get(ButtonID.ROW2_1, i);
                        this.addButton(row2ButtonID, "Row 2: " + (i + 1),
                                        new ButtonRowModeCommand<>(1, i, this.model, surface),
                                        PushControlSurface.PUSH_BUTTON_ROW2_1 + i,
                                        () -> this.getModeColor(row2ButtonID));
                        final ButtonID sceneButtonID = ButtonID.get(ButtonID.SCENE1, i);
                        this.addButton(sceneButtonID, "Scene " + (i + 1),
                                        new PushSceneButtonCommand(sceneButtonID, surface),
                                        PushControlSurface.PUSH_BUTTON_SCENE1 + 7 - i,
                                        () -> this.getButtonColorFromActiveView(sceneButtonID));
                }

                this.addButton(ButtonID.SHIFT, "Shift", new ShiftCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_SHIFT);
                this.addButton(ButtonID.SELECT, "Select", new SelectCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_SELECT);
                this.addButton(ButtonID.TAP_TEMPO, "Tap Tempo", new TapTempoCommand<>(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_TAP);
                this.addButton(ButtonID.METRONOME, "Metronome", new PushMetronomeCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_METRONOME, t::isMetronomeOn);
                this.addButton(ButtonID.MASTERTRACK, "Mastertrack", new MastertrackCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_MASTER,
                                () -> Modes.isMasterMode(modeManager.getActiveID()),
                                PushColorManager.PUSH_BUTTON_STATE_MASTER_ON,
                                PushColorManager.PUSH_BUTTON_STATE_MASTER_HI);
                this.addButton(ButtonID.PAGE_LEFT, "Page Left", new PageLeftCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_DEVICE_LEFT, () -> {

                                        if (viewManager.isActive(Views.SESSION))
                                                return this.model.getCurrentTrackBank().canScrollPageBackwards();
                                        final IView activeView = viewManager.getActive();
                                        final INoteClip clip = activeView instanceof final AbstractSequencerView<?, ?> sequencerView
                                                        && !(activeView instanceof ClipLengthView)
                                                                        ? sequencerView.getClip()
                                                                        : null;
                                        return clip != null && clip.doesExist() && clip.canScrollStepsBackwards();

                                }, ColorManager.BUTTON_STATE_OFF, ColorManager.BUTTON_STATE_ON);
                this.addButton(ButtonID.PAGE_RIGHT, "Page Right", new PageRightCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_DEVICE_RIGHT, () -> {
                ...
                this.addButton(ButtonID.MUTE, "Mute", new MuteCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_MUTE,
                                this::getMuteState, PushColorManager.PUSH_BUTTON_STATE_MUTE_ON,
                                PushColorManager.PUSH_BUTTON_STATE_MUTE_HI);
                this.addButton(ButtonID.SOLO, "Solo", new SoloCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_SOLO,
                                this::getSoloState, PushColorManager.PUSH_BUTTON_STATE_SOLO_ON,
                ...
                this.addButton(ButtonID.ADD_EFFECT, "Add Device", new PushAddEffectCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_ADD_EFFECT);
                this.addButton(ButtonID.ADD_TRACK, "Add Track",
                                new ModeSelectCommand<>(this.model, surface, Modes.ADD_TRACK),
                                isPush3 ? PushControlSurface.PUSH_BUTTON_ADD
                                                : PushControlSurface.PUSH_BUTTON_ADD_TRACK);
                this.addButton(ButtonID.NOTE, "Note", new SelectPlayViewCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_NOTE,
                                () -> !Views.isSessionView(viewManager.getActiveID()));

                final PushCursorCommand cursorDownCommand = new PushCursorCommand(Direction.DOWN, this.model, surface);
                this.addButton(ButtonID.ARROW_DOWN, "Down", cursorDownCommand, PushControlSurface.PUSH_BUTTON_DOWN,
                                cursorDownCommand::canScroll, ColorManager.BUTTON_STATE_OFF,
                ...
                this.addButton(ButtonID.ARROW_UP, "Up", cursorUpCommand, PushControlSurface.PUSH_BUTTON_UP,
                                cursorUpCommand::canScroll, ColorManager.BUTTON_STATE_OFF,
                                ColorManager.BUTTON_STATE_ON);
                final PushCursorCommand cursorLeftCommand = new PushCursorCommand(Direction.LEFT, this.model, surface);
                this.addButton(ButtonID.ARROW_LEFT, "Left", cursorLeftCommand, PushControlSurface.PUSH_BUTTON_LEFT,
                                cursorLeftCommand::canScroll, ColorManager.BUTTON_STATE_OFF,
                                ColorManager.BUTTON_STATE_ON);
                final PushCursorCommand cursorRightCommand = new PushCursorCommand(Direction.RIGHT, this.model,
                                surface);
                this.addButton(ButtonID.ARROW_RIGHT, "Right", cursorRightCommand, PushControlSurface.PUSH_BUTTON_RIGHT,
                                cursorRightCommand::canScroll, ColorManager.BUTTON_STATE_OFF,
                                ColorManager.BUTTON_STATE_ON);

                this.addButton(ButtonID.OCTAVE_DOWN, "Octave Down", new OctaveCommand(false, this.model, surface),
                                PushControlSurface.PUSH_BUTTON_OCTAVE_DOWN, () -> {
                                        final IView activeView = viewManager.getActive();
                                        return activeView instanceof final TransposeView transposeView
                                                        && transposeView.isOctaveDownButtonOn();
                                }, ColorManager.BUTTON_STATE_OFF, ColorManager.BUTTON_STATE_ON);
                this.addButton(ButtonID.OCTAVE_UP, "Octave Up", new OctaveCommand(true, this.model, surface),
                                PushControlSurface.PUSH_BUTTON_OCTAVE_UP, () -> {
                                        final IView activeView = viewManager.getActive();
                                        return activeView instanceof final TransposeView transposeView
                                                        && transposeView.isOctaveUpButtonOn();
                                }, ColorManager.BUTTON_STATE_OFF, ColorManager.BUTTON_STATE_ON);

                this.addButton(ButtonID.STOP_CLIP, "Stop Clip", new ClipStopCommand(this.model, surface),
                                PushControlSurface.PUSH_BUTTON_STOP_CLIP, () -> surface.isPressed(ButtonID.STOP_CLIP),
                                PushColorManager.PUSH_BUTTON_STATE_STOP_ON, PushColorManager.PUSH_BUTTON_STATE_STOP_HI);

                final SelectSessionViewCommand selectSessionViewCommand = new SelectSessionViewCommand(this.model,
                                surface);
                this.addButton(ButtonID.SESSION, "Session", selectSessionViewCommand,
                                PushControlSurface.PUSH_BUTTON_SESSION,
                                () -> {
                ...
                this.addButton(ButtonID.REPEAT, "Repeat", new FillModeNoteRepeatCommand<>(this.model, surface, true),
                                PushControlSurface.PUSH_BUTTON_REPEAT, this.configuration::isNoteRepeatActive);
                this.addButton(ButtonID.FOOTSWITCH2, "Foot Controller", new FootswitchCommand<>(this.model, surface, 0),
                                PushControlSurface.PUSH_FOOTSWITCH2);

                if (this.pushVersion == PushVersion.VERSION_1) {
                        this.addButton(ButtonID.VOLUME, "Volume", new VolumeCommand(this.model, surface),
                                        PushControlSurface.PUSH_BUTTON_VOLUME,
                                        () -> modeManager.isActive(Modes.VOLUME, Modes.CROSSFADER));
                        this.addButton(ButtonID.PAN_SEND, "Pan/Send", new PanSendCommand(this.model, surface),
                                        PushControlSurface.PUSH_BUTTON_PAN_SEND,
                                        () -> modeManager.isActive(Modes.PAN)
                                                        || Modes.isSendMode(modeManager.getActiveID()));
                        this.addButton(ButtonID.SETUP, "User", new SetupCommand(this.pushVersion, this.model, surface),
                                        PushControlSurface.PUSH_BUTTON_USER_MODE,
                                        () -> modeManager.isActive(Modes.USER, Modes.CONFIGURATION));
                } else {
                        this.addButton(ButtonID.LAYOUT, "Layout", new LayoutCommand(this.model, surface),
                                        PushControlSurface.PUSH_BUTTON_LAYOUT);
                        this.addButton(ButtonID.SETUP, "Setup", new SetupCommand(this.pushVersion, this.model, surface),
                                        PushControlSurface.PUSH_BUTTON_SETUP,
                                        () -> modeManager.isActive(Modes.SETUP, Modes.CONFIGURATION, Modes.INFO,
                                                        Modes.AUDIO));
                        this.addButton(ButtonID.CONVERT, "Convert", new ConvertCommand<>(this.model, surface),
                                        PushControlSurface.PUSH_BUTTON_CONVERT, () -> {
                                                if (!this.model.canConvertClip())
                                                        return 0;
                                                return surface.getButton(ButtonID.CONVERT).isPressed() ? 2 : 1;
                                        }, ColorManager.BUTTON_STATE_OFF, ColorManager.BUTTON_STATE_ON,
                                        ColorManager.BUTTON_STATE_HI);
                        this.addButton(ButtonID.USER, "User", new ModeSelectCommand<>(this.model, surface, Modes.USER),
                                        PushControlSurface.PUSH_BUTTON_USER_MODE,
                                        () -> modeManager.isActive(Modes.USER));
                }

                if (isPush3) {
                        this.addButton(ButtonID.INSERT_SCENE, "Create Scene",
                                        new CreateSceneCommand<>(this.model, surface),
                                        PushControlSurface.PUSH_CAPTURE_MIDI, (IntSupplier) null,
                                        PushColorManager.PUSH_BUTTON_STATE_INSERT_SCENE_ON,
                                        PushColorManager.PUSH_BUTTON_STATE_INSERT_SCENE_HI);
                        this.addButton(ButtonID.LOAD, "Load", new LoadCommand<>(this.model, surface),
                                        PushControlSurface.PUSH_BUTTON_FILES);
                        this.addButton(ButtonID.SAVE, "Save", new SaveCommand<>(this.model, surface),
                                        PushControlSurface.PUSH_BUTTON_SAVE, () -> this.model.getProject().isDirty());
                        ...
                        this.addButton(ButtonID.LOCK_MODE, "Lock", NopCommand.INSTANCE,
                                        PushControlSurface.PUSH_BUTTON_LOCK,
                                        () -> this.configuration.getLockState() != LockState.OFF,
                                        PushColorManager.PUSH_BUTTON_STATE_LOCK_ON,
                                        PushColorManager.PUSH_BUTTON_STATE_LOCK_HI);
                        ...
                        this.addButton(ButtonID.TOGGLE_CLIP_VIEW, "Toggle Scene View", (event, value) -> {
                                if (event == ButtonEvent.DOWN)
                                        modeManager.setActive(modeManager.isActive(Modes.SESSION) ? Modes.MARKERS
                                                        : Modes.SESSION);
                        }, PushControlSurface.PUSH_BUTTON_SESSION_DISPLAY,
                                        () -> this.configuration.isScenesClipViewSelected());
                }

                this.addButton(ButtonID.BROWSE, "Browse", new BrowserCommand<>(this.model, surface),
                                isPush3 ? PushControlSurface.PUSH_BUTTON_HOT_SWAP
                                                : PushControlSurface.PUSH_BUTTON_BROWSE,
                                () -> modeManager.isActive(Modes.BROWSER));
        }
        ...
        protected void registerContinuousCommands() {
                ...
                for (int i = 0; i < 8; i++) {
                        final IHwRelativeKnob knob = this.addRelativeKnob(ContinuousID.get(ContinuousID.KNOB1, i),
                                        "Knob " + i,
                                        new KnobRowModeCommand<>(i, this.model, surface),
                                        PushControlSurface.PUSH_KNOB1 + i);
                        knob.bindTouch(new KnobRowTouchModeCommand<>(i, this.model, surface), input, BindType.NOTE, 0,
                                        PushControlSurface.PUSH_KNOB1_TOUCH + i);
                        knob.setIndexInGroup(i);
                }

                this.masterVolumeCommand = new PushMasterVolumeCommand(this.model, surface);
                final IHwRelativeKnob knobMaster = this.addRelativeKnob(ContinuousID.MASTER_KNOB, "Master",
                                this.masterVolumeCommand, PushControlSurface.PUSH_KNOB9);
                knobMaster.bindTouch(new MastertrackTouchCommand(this.model, surface), input, BindType.NOTE, 0,
                                PushControlSurface.PUSH_KNOB9_TOUCH);

                this.tempoShuffleCommand = new RasteredKnobCommand(this.model, surface);
                final IHwRelativeKnob knobTempo = this.addRelativeKnob(ContinuousID.TEMPO, "Tempo",
                                this.tempoShuffleCommand,
                                PushControlSurface.PUSH_SMALL_KNOB1);
                knobTempo.bindTouch(this.tempoShuffleCommand, input, BindType.NOTE, 0,
                                PushControlSurface.PUSH_SMALL_KNOB1_TOUCH);

                if (this.pushVersion == PushVersion.VERSION_3) {
                        final Push3EncoderCommand encoderCommand = new Push3EncoderCommand(this.model, surface);
                        this.addRelativeKnob(ContinuousID.PLAY_POSITION, "Encoder", encoderCommand,
                                        PushControlSurface.PUSH_KNOB_ENCODER);
                        this.addButton(ButtonID.ENCODER_PUSH, "Enc.Press", encoderCommand,
                                        PushControlSurface.PUSH_BUTTON_ENCODER);
                        this.addButton(ButtonID.LEFT, "Left", (event, value) -> encoderCommand.left(event),
                                        PushControlSurface.PUSH_ENCODER_LEFT);
                        this.addButton(ButtonID.RIGHT, "Right", (event, value) -> encoderCommand.right(event),
                                        PushControlSurface.PUSH_ENCODER_RIGHT);
                        this.addButton(ButtonID.ARROW_CENTER, "Center", (event, value) -> encoderCommand.center(event),
                                        PushControlSurface.PUSH_BUTTON_CURSOR_CENTER);

                        // It seems if pitch-bend is already bound to one channel Bitwig API blocks all
                        // others
                        // as well, therefore, assign them with the API as well
                        for (int i = 1; i < 16; i++) {
                                final int midiChannel = i;
                                this.addFader(ContinuousID.get(ContinuousID.MPE_PITCH_BEND2, i - 1),
                                                "Pitchbend " + midiChannel,
                                                (data1, data2) -> this.getSurface().handleMPEPitchbend(midiChannel,
                                                                data1, data2),
                                                i);
                        }
                } else {
                        final PlayPositionKnobCommand playPositionCommand = new PlayPositionKnobCommand(this.model,
                                        surface);
                        final IHwRelativeKnob knobPlayPosition = this.addRelativeKnob(ContinuousID.PLAY_POSITION,
                                        "Play Position",
                                        playPositionCommand, PushControlSurface.PUSH_SMALL_KNOB2);
                        knobPlayPosition.bindTouch(playPositionCommand, input, BindType.NOTE, 0,
                                        PushControlSurface.PUSH_SMALL_KNOB2_TOUCH);
                }
                ...
                final IHwFader touchstrip = this.addFader(ContinuousID.TOUCHSTRIP, "Touchstrip",
                                this.touchstripCommand);
                touchstrip.bindTouch(new ConfigurePitchbendCommand(this.model, surface), input, BindType.NOTE, 0,
                                PushControlSurface.PUSH_RIBBON_TOUCH);
        }
        ...
        protected void layoutControls() {
                ...
                if (this.pushVersion == PushVersion.VERSION_1) {
                        ...
                        surface.getButton(ButtonID.ACCENT).setBounds(185.38487435513716, 65.78321712343, 10.0,
                                        6.366389099167296);
                        surface.getButton(ButtonID.ADD_EFFECT).setBounds(174.33869721660602, 93.94370160488351, 10.0,
                                        5.912187736563206);
                        surface.getButton(ButtonID.ADD_TRACK).setBounds(185.38487435513716, 93.94370160488351, 10.0,
                                        5.912187736563206);
                        surface.getButton(ButtonID.ARROW_DOWN).setBounds(182.32355717118574, 135.12462514765426,
                                        5.912187736563204,
                                        9.242997728993183);
                        surface.getButton(ButtonID.ARROW_LEFT).setBounds(174.33869721660602, 132.24801651782818,
                                        7.274791824375465,
                                        5.760787282361847);
                        surface.getButton(ButtonID.ARROW_RIGHT).setBounds(188.60970402962622, 132.0966160636268,
                                        7.274791824375465,
                                        5.760787282361847);
                        surface.getButton(ButtonID.ARROW_UP).setBounds(182.32355717118574, 124.9807947161627,
                                        5.912187736563204,
                                        9.242997728993183);
                        surface.getButton(ButtonID.AUTOMATION).setBounds(3.9828477685945423, 101.75094041477499, 10.0,
                                        6.0);
                        ...
                        surface.getButton(ButtonID.DUPLICATE).setBounds(3.9828477685945423, 108.95374891266061, 10.0,
                                        6.0);
                        surface.getButton(ButtonID.FIXED_LENGTH).setBounds(3.9828477685945423, 93.76485835884236, 10.0,
                                        6.0);
                        surface.getButton(ButtonID.MASTERTRACK).setBounds(159.75883347701458, 44.09358805454295, 10.0,
                                        5.003785011355033);
                        surface.getButton(ButtonID.METRONOME).setBounds(3.9828477685945423, 33.49555626044754, 10.0,
                                        5.003785011355033);
                        surface.getButton(ButtonID.MUTE).setBounds(174.11462454438796, 50.945972611696554, 10.0,
                                        6.366389099167296);
                        surface.getButton(ButtonID.NEW).setBounds(3.9828477685945423, 117.27727105546369, 10.0, 10.0);
                        surface.getButton(ButtonID.NOTE).setBounds(174.33869721660602, 101.96792567755568, 10.0,
                                        5.912187736563206);
                        surface.getButton(ButtonID.OCTAVE_DOWN).setBounds(174.11462454438796, 73.35323983349807, 10.0,
                                        6.366389099167296);
                        surface.getButton(ButtonID.OCTAVE_UP).setBounds(185.38487435513716, 73.35323983349807, 10.0,
                                        6.366389099167296);
                        surface.getButton(ButtonID.PAGE_LEFT).setBounds(174.11462454438796, 44.09358805454292, 10.0,
                                        6.366389099167296);
                        surface.getButton(ButtonID.PAGE_RIGHT).setBounds(185.38487435513716, 44.09358805454292, 10.0,
                                        6.366389099167296);
                        surface.getButton(ButtonID.PAN_SEND).setBounds(185.38487435513716, 17.09278823980427, 10.0,
                                        6.0);
                        ...
                        surface.getButton(ButtonID.RECORD).setBounds(3.9828477685945423, 129.39864829363117, 10.0,
                                        10.0);
                        surface.getButton(ButtonID.REPEAT).setBounds(174.11462454438796, 65.78321712343, 10.0,
                                        6.366389099167296);
                        surface.getButton(ButtonID.ROW1_1).setBounds(32.57639592970192, 43.44862211964502,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW1_2).setBounds(48.17669873061028, 43.44862211964502,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW1_3).setBounds(63.73763741342633, 43.44862211964502,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW1_4).setBounds(79.10781152394877, 43.44862211964502,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW1_5).setBounds(95.76791750426686, 43.44862211964502,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW1_6).setBounds(110.68389025218505, 43.44862211964502,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW1_7).setBounds(126.22060486232871, 43.44862211964502,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW1_8).setBounds(141.97230811743864, 43.44862211964502,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW2_1).setBounds(32.57639592970192, 51.6242466465187,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW2_2).setBounds(48.17669873061028, 51.6242466465187,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW2_3).setBounds(63.73763741342633, 51.6242466465187,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW2_4).setBounds(79.10781152394877, 51.6242466465187,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW2_5).setBounds(95.76791750426686, 51.6242466465187,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW2_6).setBounds(110.68389025218505, 51.6242466465187,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW2_7).setBounds(126.22060486232871, 51.6242466465187,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.ROW2_8).setBounds(141.97230811743864, 51.6242466465187,
                                        13.633610900832712,
                                        5.457986373959121);
                        surface.getButton(ButtonID.SCALES).setBounds(174.11462454438796, 58.0617939591608, 10.0,
                                        6.366389099167296);
                        ...
                        surface.getButton(ButtonID.SCENE5).setBounds(159.75883347701458, 105.67420879640525, 10.0,
                                        10.0);
                        surface.getButton(ButtonID.SCENE6).setBounds(159.75883347701458, 118.12841015900918, 10.0,
                                        10.0);
                        surface.getButton(ButtonID.SCENE7).setBounds(159.75883347701458, 129.93764558671543, 10.0,
                                        10.0);
                        surface.getButton(ButtonID.SCENE8).setBounds(159.75883347701458, 141.74688101442194, 10.0,
                                        10.0);
                        surface.getButton(ButtonID.SELECT).setBounds(174.33869721660602, 109.80138517793415, 10.0,
                                        5.912187736563206);
                        surface.getButton(ButtonID.SESSION).setBounds(185.38487435513716, 101.96792567755568, 10.0,
                                        5.912187736563206);
                        surface.getButton(ButtonID.SHIFT).setBounds(185.38487435513716, 109.80138517793415, 10.0,
                                        5.912187736563206);
                        surface.getButton(ButtonID.SOLO).setBounds(185.38487435513716, 50.945972611696554, 10.0,
                                        6.366389099167296);
                        surface.getButton(ButtonID.STOP_CLIP).setBounds(159.75883347701458, 51.2487735200992, 10.0,
                                        5.003785011355033);
                        surface.getButton(ButtonID.TAP_TEMPO).setBounds(3.9828477685945423, 21.837721286942664, 10.0,
                                        10.0);
                        ...
                        surface.getContinuous(ContinuousID.KNOB1).setBounds(34.771069269783915, 5.655526992287918, 10.0,
                                        10.0);
                        surface.getContinuous(ContinuousID.KNOB2).setBounds(49.71638991176253, 5.655526992287918, 10.0,
                                        10.0);
                        surface.getContinuous(ContinuousID.KNOB3).setBounds(65.9326061279787, 5.655526992287918, 10.0,
                                        10.0);
                        surface.getContinuous(ContinuousID.KNOB4).setBounds(81.17584937122217, 5.655526992287918, 10.0,
                                        10.0);
                        surface.getContinuous(ContinuousID.KNOB5).setBounds(97.9326061279789, 5.655526992287918, 10.0,
                                        10.0);
                        surface.getContinuous(ContinuousID.KNOB6).setBounds(112.04752310150776, 5.655526992287918, 10.0,
                                        10.0);
                        surface.getContinuous(ContinuousID.KNOB7).setBounds(128.21593830334197, 5.655526992287918, 10.0,
                                        10.0);
                        surface.getContinuous(ContinuousID.KNOB8).setBounds(143.5578406169669, 5.655526992287918, 10.0,
                                        10.0);
        ...
        private void updateRibbonMode() {
                ...
                if (ribbonMode == PushConfiguration.RIBBON_MODE_CC || ribbonMode == PushConfiguration.RIBBON_MODE_FADER
                                || ribbonMode == PushConfiguration.RIBBON_MODE_LAST_TOUCHED)
        ...
        private boolean getMuteState() {
                ...
                final ITrack selTrack = modeManager.isActive(Modes.MASTER) ? this.model.getMasterTrack()
                                : this.model.getCursorTrack();
